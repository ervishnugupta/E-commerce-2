  ...
  return (
    <Wrapper>
      ...
      <div className="filter-category">
        ...
        <div>
          {
            categoryOnlyData.map((currData, index)=>{
                return <button key={index} type='button' name='category' value={currData} onClick={updateFilterValue}>
                  {currData}
                </button>
            })
          }
      ...
      <div className="filter-company">
          ...
          <form action="#">
            <select name="company" id="company" className='filter-company--select' onClick={updateFilterValue}>
              {
                companyOnlyData.map((currCompany, index)=>{
                    return (<option key={index} value={currCompany} name="company" >
        ...
        <div className="filter-color-style">
          {
            colorOnlyData.map((currColor, index)=>{
              if(currColor === "All"){
                return (
                  <button key={index} type='button' value={currColor} name='color'  className='color-all--style' onClick={updateFilterValue}>
                    All
                  </button>
                )
              }
                return (
                  <button key={index} type='button' value={currColor} name='color' style={{backgroundColor : currColor}} className={color === currColor ? 'btnStyle active' : "btnStyle"} onClick={updateFilterValue}>
